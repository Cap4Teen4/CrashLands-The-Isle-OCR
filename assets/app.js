...
const BUNNY_LOCATIONS = [
  [128, -36], [202, -42], [-128, -72], [-108, 202], [-150, 234],
  [-180, 268], [-200, 256], [-212, 246], [-202, 272], [-232, 280],
  [-178, 178], [-166, 168], [-80, -18], [-62, -22], [-90, -74],
  [-122, -64], [-52, -202], [-10, -216], [24, -174], [-10, -92],
  [-18, -62], [8, -34], [120, -50], [134, -58], [134, -114],
  [164, -130], [204, -128], [258, -80], [180, -12], [210, 34],
  [236, 100], [236, 102], [302, -284], [302, -284], [336, -286],
  [344, -268], [360, -270], [410, -286], [386, -346], [414, -422],
  [406, -456], [368, -484], [350, -476], [342, -408], [290, -406],
  [358, -380], [198, 48], [200, 84], [502, -136], [266, -282],
  [262, -288],
];
...
const CHICKEN_LOCATIONS = [
  [92, -194], [56, -118], [330, -144], [386, -146], [-116, -78],
  [-396, -116], [-320, 346], [-206, 50], [118, 28], [132, 240],
  [456, -50], [-226, 244], [530, -182], [504, 284], [458, 338],
  [478, 362], [-260, -374], [310, -330], [134, -374], [166, -304],
  [128, -46], [-224, 158], [-250, 140], [396, 196], [414, 14],
  [400, -44], [372, -142], [328, -404], [262, -274],
];
...
const DEER_LOCATIONS = [
  [-72, 282], [-276, 238], [-134, 186], [372, -34], [332, -88],
  [-342, -124], [94, -180], [120, -328], [196, -350], [114, -354],
  [132, 240], [-16, -114], [466, 200], [454, 338], [-252, -362],
  [-298, 330], [-290, 312], [132, 222], [120, -110], [94, -30],
  [-132, 206], [-212, 254], [-240, 132], [-354, 160], [86, -136],
  [176, 158], [440, -174], [540, -216], [472, -222], [488, -274],
  [492, -106], [406, -68], [334, -236], [302, -398], [268, -278],
];
...
const GOAT_LOCATIONS = [
  [-146, -12], [14, -114], [68, -6], [98, -32], [108, -124],
  [50, -118], [72, 22], [16, -112], [-166, -120], [98, 26],
  [98, 26], [114, 14], [96, 98], [-128, -30], [-116, -50],
  [472, -116], [308, -412], [316, -454],
];
...
canvas.addEventListener('mousemove', e => {
  ...
  mouseWorldX = (sx - canvas.width / 2) / zoom - viewX;
  mouseWorldY = (sy - canvas.height / 2) / zoom - viewY;
...
for (let gy = Math.floor(startWY / minorGrid) * minorGrid; gy < endWY; gy += minorGrid) {
  ...
  const BUILDING_LABELS = [
    ['Port', 518, -214],
    ['Volcano Bunker', 273, -204],
    ['I12', 87, -44],
    ['K15', 254, 31],
    ['Swamp Tunnel', 125, 175],
    ['Entrance', 35, 143],
    ['Perimeter', -45, 150],
  ];
...
function toggleAllFoodOverlays() {
  // Check if all are currently on
  const allOn = showBoar && showBunny && showChicken && showCrab && showDeer && showFrog && showGoat && showTurtle;
...
function initializeCheckboxes() {
  ...
  document.getElementById('check-all-food').checked = showBoar && showBunny && showChicken && showCrab && showDeer && showFrog && showGoat && showTurtle;
}
